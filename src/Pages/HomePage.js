...
export const HomePage = (props) => {
    ...
    const [priceData, setPriceData] = useState(FAKE_PRODUCT_DATA_MAIN);
                            ...
                            <div className="price-tabel-block">
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    {priceData.map((category, index) => {
                                        currentCategory === '' && setCurrentCategory(category.slug);

                                        return (
                                            <li key={`category-${index}`} className="nav-item" role="presentation">
                                                <button className={`nav-link ${currentCategory === category.slug ? 'active' : ''} br`} id={`tab${index}-tab`} data-toggle="tab"
                                    ...
                                    {priceData.map((categoryTab, index) => {
                                        return (
                                            <div key={`category-tab-${index}`}
                                                 className={`tab-pane fade ${currentCategory === categoryTab.slug ? 'show active' : ''}`}
                                                 id={`tab${index}`}
                                                 role="tabpanel"
                                            ...
                                            >
                                                ...
                                                <table className="table">
                                                    ...
                                                    <tbody>
                                                        {categoryTab.products.map((product, i) => {
                                                            return (
                                                                <tr key={`product-${i}`}>
                    ...
                    <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                        ...
                        <div className="contact-right">
                            ...
                            <div className="contact-row">
                                <img src={map} className="img-icon" alt="map-marker"/><span>Пресненская наб., 8, стр. 1, Москва, Россия</span>
                            </div>
                            <div className="contact-title">Телефоны для связи</div>
                            <div className="contact-row">
                                <img src={phone} className="img-icon" alt="phone"/><span><a href="tel:+74993777770">+7 (499) 377-77-70</a></span>
                            </div>
                            <div className="contact-title">E-mail по всем вопросам</div>
                            <div className="contact-row">
                                <img src={message} className="img-icon" alt="email"/>
                                <span>
