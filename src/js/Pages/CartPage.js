                ...
                <div className="container container-cart">
                    <div className="row cart-row">
                        <div>
                            <div className="cart_item-row br bg-wh">
                                ...
                                <div className="cart_item-row-clean">Очистить<img src="/images/icon/close_ring.svg" alt=""/></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row cart_produkt">
                        <div>
                            <div className="product_item-row br">
                                ...
                                <img src="/images/icon/close_ring.svg" alt="cart-del"/>
                            </div>
                        </div>
                    </div>
                    <div className="row cart_produkt">
                    ...
                    <div className="contact-cart">
                        <div className="contact-row">
                            <img src="/images/icon/phone.svg" className="img-icon" alt=""/><span><a href="tel:+74951288380">+7 (495) 128-83-80</a></span>
                        </div>
                        <div className="contact-row">
